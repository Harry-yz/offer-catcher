...
严格按此JSON格式输出：
{"overall_score":85,"matched":[{"requirement":"Python","evidence":"项目使用Python","strength":"强","score":95}],"missing":[{"requirement":"Go语言","severity":"中","suggestion":"建议补充"}],"analysis":"一句话总结","optimization":[{"original":"原表述","suggested":"建议表述","reason":"原因"}]}"""
